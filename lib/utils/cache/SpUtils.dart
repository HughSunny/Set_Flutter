...
import 'package:set_flutter/app/OsApplication.dart';
import 'package:set_flutter/model/UserInfoBean.dart';
...
class SpUtils {
  ...
  static const SP_GOV = 'sp_gov';

  static void saveGovData(String key, dynamic value) async {
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    sharedPreferences.setString(SP_GOV+ key, jsonEncode(value));
  }

  static Future<List<dynamic>> getLovData(String key) async {
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    var value = sharedPreferences.getString(SP_GOV+ key);
