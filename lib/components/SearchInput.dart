        ...
        child: new Row(
          children: <Widget>[
            new Container(width: 30.0,
                child: new Icon(icon, color: Color(AppColor.subTextColor),)) ??
                null,
            new Expanded(child: Padding(
                padding: EdgeInsets.fromLTRB(10, 0, 0, 0),
                child: new Text(text, style: Theme
                    .of(context)
                    .textTheme
                    .subhead)),),
        ...
        builder: (FormFieldState<T> field) {
          return new InputDecorator(
            ...
            decoration: new InputDecoration(
              labelText: widget.value != null ? widget.value : widget
                  .placeholder,
              labelStyle: TextStyle(color: Color(
                  widget.value != null ? AppColor.mainTextColor : AppColor
                      .subTextColor)),
        ...
        children: <Widget>[
          new Padding(
            ...
            child: new Icon(Icons.search,
                size: 24.0, color:Color(AppColor.subTextColor)),
          ),
          new Expanded(
